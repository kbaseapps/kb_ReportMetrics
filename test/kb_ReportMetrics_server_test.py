...
class kb_ReportMetricsTest(unittest.TestCase):
    ...
    def test_run_report_metrics(self):
        m_params = {
            'stats_name':'user_narrative_stats',#'user_counts_per_day',#'total_logins',#'user_details','user_ws_stats','user_narrative_stats','exec_stats','exec_aggr_table','exec_stats','exec_aggr_stats','user_job_states'
            'user_ids':[],#['qzhang'],#'user_ids': [],

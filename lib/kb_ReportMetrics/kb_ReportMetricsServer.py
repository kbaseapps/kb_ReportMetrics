...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'kb_ReportMetrics'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from kb_ReportMetrics.kb_ReportMetricsImpl import kb_ReportMetrics  # noqa @IgnorePep8
impl_kb_ReportMetrics = kb_ReportMetrics(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'kb_ReportMetrics'
        ...
        self.rpc_service.add(impl_kb_ReportMetrics.report_metrics,
                             ...
                             types=[dict])
        self.method_authentication['kb_ReportMetrics.report_metrics'] = 'required'  # noqa
        self.rpc_service.add(impl_kb_ReportMetrics.dummy_test0,
                             name='kb_ReportMetrics.dummy_test0',
                             types=[dict])
        self.method_authentication['kb_ReportMetrics.dummy_test0'] = 'required'  # noqa
        self.rpc_service.add(impl_kb_ReportMetrics.status,
                             name='kb_ReportMetrics.status',
                             types=[dict])
